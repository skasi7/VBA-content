...
|:-----|:-----|:-----|:-----|
| _ObjectName_|Required| **String**|The class name of the object to create. For information about valid class names, see [OLE Programmatic Identifiers](http://msdn.microsoft.com/library/ole-programmatic-identifiers-outlook%28Office.15%29.aspx).|
