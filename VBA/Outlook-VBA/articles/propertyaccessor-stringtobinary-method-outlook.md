...
For more information on type conversion when using the  **PropertyAccessor** object, see[Best Practices for Getting and Setting Properties](http://msdn.microsoft.com/library/best-practices-for-getting-and-setting-properties%28Office.15%29.aspx).
