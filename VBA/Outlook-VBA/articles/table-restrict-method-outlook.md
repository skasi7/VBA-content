...
For more information on specifying filters for the  **Table** object, see[Filtering Items](http://msdn.microsoft.com/library/filtering-items%28Office.15%29.aspx).
