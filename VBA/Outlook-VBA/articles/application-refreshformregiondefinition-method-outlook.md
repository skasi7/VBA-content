...
For more information about registering form regions, see [Specifying Form Regions in the Windows Registry](http://msdn.microsoft.com/library/specifying-form-regions-in-the-windows-registry%28Office.15%29.aspx).
