...
-  [Search the Calendar for Appointments that Occur Partially or Entirely in a Given Time Period](search-the-calendar-for-appointments-that-occur-partially-or-entirely-in-a-given-time-period.md)
    
-  [Search the Calendar for Appointments Within a Date Range that Contain a Specific Word in the Subject](search-the-calendar-for-appointments-within-a-date-range-that-contain-a-specific-word-in-the-subject.md)
