...
For more infomation on programming a form region, see [Extending a Form Region with an Add-in](http://msdn.microsoft.com/library/extending-a-form-region-with-an-add-in%28Office.15%29.aspx).
