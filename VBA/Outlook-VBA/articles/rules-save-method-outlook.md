 ...
 **Rules.Save** can be an expensive operation in terms of performance on slow connections to Exchange server. For more information on using the progress dialog box, see[Manage Rules in the Outlook Object Model](http://msdn.microsoft.com/library/managing-rules-in-the-outlook-object-model%28Office.15%29.aspx).
