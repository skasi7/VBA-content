...
[How to: Create a Sendable Item for a Specific Account Based on the Current Folder](http://msdn.microsoft.com/library/create-a-sendable-item-for-a-specific-account-based-on-the-current-folder-outlook%28Office.15%29.aspx)
