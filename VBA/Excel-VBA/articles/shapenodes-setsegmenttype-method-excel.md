...
| _SegmentType_|Required| **[MsoSegmentType](http://msdn.microsoft.com/library/msosegmenttype-enumeration-office%28Office.15%29.aspx)**|Specifies if the segment is straight or curved.|
