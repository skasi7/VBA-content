...
Returns or sets the length of the arrowhead at the end of the specified line. Read/write  **[MsoArrowheadLength](http://msdn.microsoft.com/library/msoarrowheadlength-enumeration-office%28Office.15%29.aspx)** .
