 ...
 **Note**  Working with objects (e g  **Interior** Object) requires adding a reference to an object. You will find more information about assigning an Object reference to a variable or property in the[Set Statement](http://msdn.microsoft.com/library/set-statement%28Office.15%29.aspx).
