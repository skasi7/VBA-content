...
Returns or sets a  **[DocumentProperties](http://msdn.microsoft.com/library/documentproperties-object-office%28Office.15%29.aspx)** collection that represents all the custom document properties for the specified workbook.
