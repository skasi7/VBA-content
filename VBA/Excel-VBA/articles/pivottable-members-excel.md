---
title: PivotTable Members (Excel)
ms.prod: EXCEL
ms.assetid: 8e8d1692-cf32-63c6-a1f6-54ddcc2a4964
---
...
|[HasAutoFormat](pivottable-hasautoformat-property-excel.md)| **True** if the PivotTable report is automatically formatted when it's refreshed or when fields are moved. Read/write **Boolean** .|
...
|[ShowTableStyleLastColumn](pivottable-showtablestylelastcolumn-property-excel.md)|Returns or sets if the last column is displayed for the specified  **PivotTable** object. Read/Write. **Boolean** .|
