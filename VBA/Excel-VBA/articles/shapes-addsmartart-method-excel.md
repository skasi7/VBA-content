...
|:-----|:-----|:-----|:-----|
| _Layout_|Required| **[SmartArtLayout](http://msdn.microsoft.com/library/smartartlayout-object-office%28Office.15%29.aspx)**|An object that represents the layout to use.|
