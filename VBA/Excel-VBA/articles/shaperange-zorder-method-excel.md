...
|:-----|:-----|:-----|:-----|
| _ZOrderCmd_|Required| **[MsoZOrderCmd](http://msdn.microsoft.com/library/msozordercmd-enumeration-office%28Office.15%29.aspx)**|Specifies where to move the specified shape relative to the other shapes.|
