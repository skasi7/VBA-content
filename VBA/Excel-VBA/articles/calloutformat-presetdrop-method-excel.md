...
|:-----|:-----|:-----|:-----|
| _DropType_|Required| **[MsoCalloutDropType](http://msdn.microsoft.com/library/msocalloutdroptype-enumeration-office%28Office.15%29.aspx)**|The starting position of the callout line relative to the text bounding box.|
