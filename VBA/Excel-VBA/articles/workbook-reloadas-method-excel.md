...
|:-----|:-----|:-----|:-----|
| _Encoding_|Required| **[MsoEncoding](http://msdn.microsoft.com/library/msoencoding-enumeration-office%28Office.15%29.aspx)**|The encoding that is to be applied to the workbook.|
