...
This example sets the color transformation to grayscale through  **[MsoPictureColorType](http://msdn.microsoft.com/library/msopicturecolortype-enumeration-office%28Office.15%29.aspx)** for shape one on `myDocument`. Shape one must be either a picture or an OLE object.
