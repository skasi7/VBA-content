...
| _AnimateBackground_|Required|**[MsoTriState](http://msdn.microsoft.com/library/msotristate-enumeration-office%28Office.15%29.aspx)**|Determines whether the text will be animated separately from the background.|
