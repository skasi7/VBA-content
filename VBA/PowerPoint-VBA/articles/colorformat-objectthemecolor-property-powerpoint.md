...
The value of the  **ObjectThemeColor** property can be one of these **[MsoThemeColorIndex](http://msdn.microsoft.com/library/msothemecolorindex-enumeration-office%28Office.15%29.aspx)** constants.
