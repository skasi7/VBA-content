...
|:-----|:-----|:-----|:-----|
| _SegmentType_|Required|**[MsoSegmentType](http://msdn.microsoft.com/library/msosegmenttype-enumeration-office%28Office.15%29.aspx)**|The type of segment to be added.|
| _EditingType_|Required|**[MsoEditingType](http://msdn.microsoft.com/library/msoeditingtype-enumeration-office%28Office.15%29.aspx)**|The editing property of the vertex. If SegmentType is  **msoSegmentLine**, EditingType must be **msoEditingAuto**.|
