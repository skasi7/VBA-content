...
| _Gallery_|Optional|**Variant**|One of the  **[XlChartType](http://msdn.microsoft.com/library/xlcharttype-enumeration-excel%28Office.15%29.aspx)** constants that specifies the chart type.|
