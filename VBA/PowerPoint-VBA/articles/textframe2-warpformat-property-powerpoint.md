...
The value of the  **WarpFormat** property can be one of the **[MsoWarpFormat](http://msdn.microsoft.com/library/msowarpformat-enumeration-office%28Office.15%29.aspx)** constants.
