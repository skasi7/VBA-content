...
| _ChartType_|Optional|**Variant**|An  **[XlChartType](http://msdn.microsoft.com/library/xlcharttype-enumeration-excel%28Office.15%29.aspx)** constant that represents the type of chart.|
