...
This code example creates a [Recordset](http://msdn.microsoft.com/library/recordset-object-ado%28Office.15%29.aspx) on the server side. It has two columns with four rows each. Cut and paste the following code to Notepad or another text editor and save it as **CreateRecordsetVBS.asp**.
