...
When you click a toggle button that's bound to a Yes/No field, Microsoft Access displays the value in the underlying table according to the field's  **[Format](http://msdn.microsoft.com/library/combobox-format-property-access%28Office.15%29.aspx)** property (Yes/No, **True** / **False**, or On/Off).
