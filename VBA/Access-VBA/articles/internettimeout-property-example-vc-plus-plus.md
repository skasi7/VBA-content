...
This example demonstrates the [InternetTimeout](http://msdn.microsoft.com/library/internettimeout-property-rds%28Office.15%29.aspx) property, which exists on the[DataControl](http://msdn.microsoft.com/library/datacontrol-object-rds%28Office.15%29.aspx) and[DataSpace](http://msdn.microsoft.com/library/dataspace-object-rds%28Office.15%29.aspx) objects. In this case, the **InternetTimeout** property is demonstrated on the **DataControl** object and the timeout is set to 20 seconds.
