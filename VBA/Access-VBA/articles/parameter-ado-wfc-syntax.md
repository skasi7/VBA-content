...
The [Value](http://msdn.microsoft.com/library/value-property-ado%28Office.15%29.aspx) property of a[Parameter](http://msdn.microsoft.com/library/parameter-object-ado%28Office.15%29.aspx) object gets or sets the content of that object. The content is represented as a VARIANT, a type of object that can be assigned a value and any of several data types.
