...
You can set event properties in the [property sheet](http://msdn.microsoft.com/library/set-form-report-and-control-properties%28Office.15%29.aspx) for an object, in a macro , or by using Visual Basic. Note that you can't set any event properties while you're formatting or printing a form or report.
