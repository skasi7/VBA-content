...
The following example shows how to use the [CreateObject](http://msdn.microsoft.com/library/createobject-method-rds%28Office.15%29.aspx) method of the[RDS.DataSpace](http://msdn.microsoft.com/library/dataspace-object-rds%28Office.15%29.aspx) with the default business object,[RDSServer.DataFactory](http://msdn.microsoft.com/library/datafactory-object-rdsserver%28Office.15%29.aspx). To test this example, cut and paste this code between the <Body> and </Body> tags in a normal HTML document and name it  **DataSpaceVBS.asp**. ASP script will identify your server.
