...
| _Method_|Optional|**MsoExtraInfoMethod**|A  **[MsoExtraInfoMethod](http://msdn.microsoft.com/library/msoextrainfomethod-enumeration-office%28Office.15%29.aspx)** constant that specifies how the _extrainfo_ argument is attached. The default is **msoMethodGet**.|
