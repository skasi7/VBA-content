...
This example demonstrates the [Type](http://msdn.microsoft.com/library/type-property-ado%28Office.15%29.aspx) property by displaying the name of the constant that corresponds to the value of the **Type** property of all the[Field](http://msdn.microsoft.com/library/field-object-ado%28Office.15%29.aspx) objects in the ** _Employees_** table. The FieldType function is required for this procedure to run.
