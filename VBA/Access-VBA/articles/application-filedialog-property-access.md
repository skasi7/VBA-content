...
|:-----|:-----|:-----|:-----|
| _dialogType_|Required|**MsoFileDialogType**|An  **[MsoFileDialogType](http://msdn.microsoft.com/library/msofiledialogtype-enumeration-office%28Office.15%29.aspx)** constant that represents the type of dialog box.|
