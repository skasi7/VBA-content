...
The  **MacroError** object does not contain information about run-time errors that occur when running Visual Basic for Applications (VBA) code. See[Elements of Run-Time Error Handling](http://msdn.microsoft.com/library/elements-of-run-time-error-handling%28Office.15%29.aspx) for more information about handling run-time errors in VBA.
