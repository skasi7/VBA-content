...
In a client database, the  **RefreshRecord** method is equivalent to the **[Refresh](form-refresh-method-access.md)** method of the **Form** object. In a web database, see the **[RefreshRecord](http://msdn.microsoft.com/library/refreshrecord-macro-action%28Office.15%29.aspx)** macro action.
