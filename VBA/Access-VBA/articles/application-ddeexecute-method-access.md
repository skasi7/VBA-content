...
From Visual Basic, you can use the  **DDEExecute** statement only to send commands to another application. For information on sending commands to Microsoft Access from another application, see[Use Microsoft Access as a DDE Server](http://msdn.microsoft.com/library/use-microsoft-access-as-a-dde-server%28Office.15%29.aspx).
