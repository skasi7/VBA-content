...
- The [ADO for Visual C++ Syntax Index with #import](ado-for-visual-c--syntax-index-with-import.md) covers ADO properties and methods when using the **#import** compiler directive with Microsoft Visual C++.
