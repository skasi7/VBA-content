...
Specifies which records from the tables listed in the [FROM](from-clause-microsoft-access-sql.md) clause are affected by a[SELECT](http://msdn.microsoft.com/library/select-statement-microsoft-access-sql%28Office.15%29.aspx), [UPDATE](http://msdn.microsoft.com/library/update-statement-microsoft-access-sql%28Office.15%29.aspx), or [DELETE](http://msdn.microsoft.com/library/delete-statement-microsoft-access-sql%28Office.15%29.aspx) statement.
