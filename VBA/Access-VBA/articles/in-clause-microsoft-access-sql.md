...
| _tableexpression_|The name of the table or tables from which data is retrieved. This argument can be a single table name, a saved query, or a compound resulting from an [INNER JOIN](http://msdn.microsoft.com/library/inner-join-operation-microsoft-access-sql%28Office.15%29.aspx), [LEFT JOIN](http://msdn.microsoft.com/library/left-join-right-join-operations-microsoft-access-sql%28Office.15%29.aspx), or [RIGHT JOIN](http://msdn.microsoft.com/library/left-join-right-join-operations-microsoft-access-sql%28Office.15%29.aspx).|
