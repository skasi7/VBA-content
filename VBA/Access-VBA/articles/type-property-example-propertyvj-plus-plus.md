...
This example demonstrates the [Type](http://msdn.microsoft.com/library/type-property-ado%28Office.15%29.aspx) property. It is a model of a utility for listing the names and types of a collection, like[Properties](http://msdn.microsoft.com/library/properties-collection-ado%28Office.15%29.aspx), [Fields](http://msdn.microsoft.com/library/fields-collection-ado%28Office.15%29.aspx), etc.

We do not need to open the [Recordset](http://msdn.microsoft.com/library/recordset-object-ado%28Office.15%29.aspx) to access its **Properties** collection; they come into existence when the **Recordset** object is instantiated. However, setting the[CursorLocation](http://msdn.microsoft.com/library/cursorlocation-property-ado%28Office.15%29.aspx) property to **adUseClient** adds several dynamic properties to the **Recordset** object's **Properties** collection, making the example a little more interesting. For sake of illustration, we explicitly use the[Item](http://msdn.microsoft.com/library/item-property-ado%28Office.15%29.aspx) property to access each[Property](http://msdn.microsoft.com/library/property-object-ado%28Office.15%29.aspx) object.
