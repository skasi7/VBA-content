...
- In a Microsoft Access database, you can add it by using the  **[CreateProperty](http://msdn.microsoft.com/library/database-createproperty-method-dao%28Office.15%29.aspx)** method and append it to the **Properties** collection of the **Database** object.
    
- In a Microsoft Access project (.adp), you can add it to the  **[AccessObjectProperties](http://msdn.microsoft.com/library/accessobjectproperties-object-access%28Office.15%29.aspx)** collection of the **[CurrentProject](http://msdn.microsoft.com/library/currentproject-object-access%28Office.15%29.aspx)** object by using the **[Add](http://msdn.microsoft.com/library/accessobjectproperties-add-method-access%28Office.15%29.aspx)** method.
