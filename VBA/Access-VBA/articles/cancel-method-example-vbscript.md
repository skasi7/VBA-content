...
The following example shows how to read the [Cancel](http://msdn.microsoft.com/library/cancel-method-ado%28Office.15%29.aspx) method at run time. Cut and paste the following code to Notepad or another text editor and save it as **CancelVBS.asp**. You can view the result in any client browser.
