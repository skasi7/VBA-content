...
| _Flags_|Required|INT16|A [VisBoundingBoxArgs Enumeration (Visio)](http://msdn.microsoft.com/library/visboundingboxargs-enumeration-visio%28Office.15%29.aspx)s constant that describe the returned rectangle.|
...
[VisBoundingBoxArgs Enumeration (Visio)](http://msdn.microsoft.com/library/visboundingboxargs-enumeration-visio%28Office.15%29.aspx)
