...
Event codes are declared by the Microsoft Visio type library in  **[VisEventCodes](viseventcodes-enumeration-visio.md)** . They are prefixed with " **visEvt** ". For a list of event codes, see[Event Codes](http://msdn.microsoft.com/library/event-codes-visio%28Office.15%29.aspx).
