...
For a list of commands that can be used with the  **DoCmd** method, see the topic[DoCmd/DOCMD Commands ](http://msdn.microsoft.com/library/docmd-docmd-commands%28Office.15%29.aspx) in this Automation Reference.
