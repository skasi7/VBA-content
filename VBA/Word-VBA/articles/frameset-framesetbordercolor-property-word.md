...
This property can be any of the  **WdColor** constants or a value returned by Visual Basic's **RGB** function. For more information on creating frames pages, see[Creating frames pages](http://msdn.microsoft.com/library/creating-frames-pages%28Office.15%29.aspx).
