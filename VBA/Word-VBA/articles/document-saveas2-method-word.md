...
| _Encoding_|Optional| **Variant**|The code page, or character set, to use for documents saved as encoded text files. The default is the system code page. You cannot use all  **[MsoEncoding](http://msdn.microsoft.com/library/msoencoding-enumeration-office%28Office.15%29.aspx)** constants with this parameter.|
