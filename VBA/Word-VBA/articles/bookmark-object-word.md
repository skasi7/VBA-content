...
You can use [predefined bookmarks](http://msdn.microsoft.com/library/predefined-bookmarks%28Office.15%29.aspx)with the  **Bookmarks** property. The following example sets the bookmark named "currpara" to the location marked by the predefined bookmark named "\Para".
