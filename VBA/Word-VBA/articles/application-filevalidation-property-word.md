...
Returns or sets how Word will validate files before opening them. Read/write [MsoFileValidationMode](http://msdn.microsoft.com/library/msofilevalidationmode-enumeration-office%28Office.15%29.aspx).
