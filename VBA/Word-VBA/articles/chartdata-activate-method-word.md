...
If the chart is linked to a Microsoft Excel workbook, this method does not run any Auto_Activate or Auto_Deactivate macros that might be attached to the workbook (use the  **[RunAutoMacros](http://msdn.microsoft.com/library/workbook-runautomacros-method-excel%28Office.15%29.aspx)** method to run those macros).
