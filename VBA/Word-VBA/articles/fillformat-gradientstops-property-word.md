...
Gradients are a smooth transition from one color state to another. The endpoints of these sections are called stops. You can use the [GradientStops.Insert](http://msdn.microsoft.com/library/gradientstops-insert-method-office%28Office.15%29.aspx) method to add gradient stops to the **GradientStops** collection for the specified object.
