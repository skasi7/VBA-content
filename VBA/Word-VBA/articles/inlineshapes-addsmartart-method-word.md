...
|:-----|:-----|:-----|:-----|
| _Layout_|Required| **[SMARTARTLAYOUT]**|A [SmartArtLayout](http://msdn.microsoft.com/library/smartartlayout-object-office%28Office.15%29.aspx)object that specifies the layout for the SmartArt graphic.|
