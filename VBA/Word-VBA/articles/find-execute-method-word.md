...
| _Replace_|Optional| **Variant**|Specifies how many replacements are to be made: one, all, or none. Can be any  **[WdReplace](http://msdn.microsoft.com/library/wdreplace-enumeration-word.md.aspx)** constant.|
