...
The  **Type** property value can be one of the ** [MsoShadowType](http://msdn.microsoft.com/library/msoshadowtype-enumeration-office%28Office.15%29.aspx)** constants declared in the Microsoft Office type library.
